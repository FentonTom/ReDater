...
hostname Ubuntu03
echo $HN1
powershell -f ReDater/ESXiReDater_v04.ps1 MyLogs/Lab05a.log MyLogs/NewLab05a.log
/usr/bin/loginsight-importer --source MyLogs/NewLab05a.log --server 10.0.0.29 --honor_timestamp --username admin --password VMware1! --tags "{\"Lab\":\"Lab05a\"}"
hostname $HN1 
